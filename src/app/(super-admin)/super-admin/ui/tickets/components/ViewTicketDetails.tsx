...
export default function ViewTicketDetails({ ticket, onClose }: ViewTicketDetailsProps) {
  ...
  return (
    <div className="w-full max-w-[640px] rounded-lg bg-white p-4 shadow-sm">
      {/* Title */}
      ...
      {/* ================= TICKET DETAILS ================= */}
      <div className="mb-3 rounded-md border border-[#E1E5EC] p-3">
        <h3 className="mb-3 text-[13px] font-semibold text-[#172554]">
          Ticket Details
        </h3>
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-3">
          ...
          <div>
            ...
            <input
              value={status}
              readOnly
              className="h-[32px] w-full rounded border border-[#D9DDE5] bg-white px-2 text-[12px] text-[#E5A32A] outline-none"
            />
          </div>
          ...
          <div className="col-span-2">
            ...
            <textarea
              value={description}
              readOnly
              className="h-[70px] w-full resize-none rounded border border-[#D9DDE5] bg-white p-2 text-[12px] text-[#596579] outline-none"
            />
          </div>
        </div>
      </div>
      ...
      <div className="rounded-md border border-[#E1E5EC] p-3">
        <h3 className="mb-3 text-[13px] font-semibold text-[#172554]">
          Conversation Summary
        </h3>
