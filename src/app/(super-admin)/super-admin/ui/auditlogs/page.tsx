...
import AuditCards from "./statscards/AuditCards";
import AuditTable from "./bottomsection/AuditTable";
        ...
        <BaseSuperLayout>
            ...
            <div className="min-h-screen bg-[#F4F6FB] dark:bg-[#252525] rounded-xl p-5">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <AuditCards type="totalLogs" />
                    <AuditCards type="UsersActivities" />
                    <AuditCards type="FailedActions" />
