...
const SidebarItems = [
  { name: 'Dashboard', href: '/modules/users/Academic-coach/ui/dashboard', icon: RiDashboardFill },
  { name: 'Trial Management', href: '/modules/users/Academic-coach/ui/trailmanagement', icon: Users },
  { name: 'Manage Students', href: '/modules/users/Academic-coach/ui/managestudents', icon: PiStudent },
  { name: 'Manage Teachers', href: '/modules/users/Academic-coach/ui/manageteacher', icon: FaBookOpenReader },
  { name: 'Schedule', href: '/modules/users/Academic-coach/ui/schedule', icon: MdOutlineCalendarToday },
  { name: 'Messages', href: '/modules/users/Academic-coach/ui/messages', icon: LuMessagesSquare },
  { name: 'Support', href: '/modules/users/Academic-coach/ui/support', icon: CircleHelp }
];
